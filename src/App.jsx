...
import RequestedHoodsChat from "./pages/hoods/RequestedHoodsChat";
import ReceivedHoodsChat from "./pages/hoods/ReceivedHoodsChat";
import ConnectedHoodsChat from "./pages/hoods/ConnectedHoodsChat";
        ...
        <div>
          ...
          <main>
            <Routes>
              ...
              <Route
                path="/requested-hoods/:id"
                element={<RequestedHoodsChat />}
              ></Route>
              <Route
                path="/received-hoods/:id"
                element={<ReceivedHoodsChat />}
              ></Route>
              <Route
                path="/connected-hoods/:id"
                element={<ConnectedHoodsChat />}
              ></Route>
